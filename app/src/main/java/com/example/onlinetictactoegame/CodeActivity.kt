    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Create.setOnClickListener {
            ...
            if (code != "null" && code != null && code != "") {
                ...
                isCodeMaker = true;
                FirebaseDatabase.getInstance("https://gamettt-b7471-default-rtdb.europe-west1.firebasedatabase.app").reference.child("codes")
        ...
        Join.setOnClickListener {
            ...
            if (code != "null" && code != null && code != "") {
                ...
                errorMsg("you didn't entered Code Properly")
            }
        }
